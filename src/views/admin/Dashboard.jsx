...
export default function Dashboard() {
  return (
    <>
      <div className="grid grid-cols-4 gap-4 mx-6 pt-0 h-screen">
        {/* Card Stats */}
        ...
        {/* Card LineChart */}
        <div className="col-span-3 bg-white shadow-md h-96">
          <CardLineChart/>
        </div>

        {/* Card Courses */}
        <div className="col-span-4 bg-white shadow-md h-80">
          <CardCourses/>
        </div>
      </div>
    </>
