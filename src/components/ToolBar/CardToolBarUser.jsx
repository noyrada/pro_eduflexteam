...
import UserModal from "../../views/CRUD/user/CreateUser"; // Adjust the path as necessary
...
export default function CardToolBarUser() {
    ...
    return (
        <div className="bg-white p-2 rounded-md text-sm font-suwannaphum">
            ...
            {/* Role Modal */}
            <UserModal isOpen={isModalOpen} onClose={closeModal} onSubmit={handleRoleSubmit} />
        </div>
    );
}
