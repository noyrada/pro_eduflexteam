        ...
        <div className="bg-white p-2 rounded-md font-suwannaphum text-sm">
            <div className="flex justify-between items-center">
                ...
                <div className="flex space-x-4 items-center">
                    ...
                    <button
                        onClick={openModal}
                        className="bg-gray-300 text-gray-900 py-2 px-3 rounded-md flex items-center shadow-md"
                    >
                    ...
                    {/* Filter Button */}
                    <button className="bg-gray-300 text-gray-900 py-2 px-3 rounded-md flex items-center shadow-md">
